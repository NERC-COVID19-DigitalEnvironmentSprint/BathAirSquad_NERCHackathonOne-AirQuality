...
# Model 1 describes the impact of average Air Quality Index (using weekly data for faster computation).
# Model 2 describes the impact of each pollutant separately (using daily data).
# Model 3 compares the impact of average Air Quality Index (for 2019) to the impact of the current Air Quality Index (using daily data).
